...
from cometarios.forms import FormComentario
from cometarios.models import Comentario
...
class PostIndex(ListView):
    ...
    def get_queryset(self):
        ...
        qs = qs.select_related('categorias_post')
...
class PostBusca(PostIndex):
    ...
    def get_queryset(self):
        ...
        qs = qs.filter(
            ...
            Q(categorias_post__nome_cat__iexact=termo)
        )
...
class PostCategoria(PostIndex):
    ...
    def get_queryset(self):
        ...
        qs = qs.filter(categorias_post__nome_cat__iexact=categoria)
